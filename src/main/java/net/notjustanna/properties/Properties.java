package net.notjustanna.properties;
 ...
 * Compatible with files generated by the original Properties class.
 *
...
public class Properties extends ConcurrentHashMap<String, String> {
    ...
    public synchronized void store(@NotNull File file, @Nullable String comments) throws IOException {
        _store(
            new BufferedWriter(new OutputStreamWriter(Files.newOutputStream(file.toPath()), StandardCharsets.ISO_8859_1)),
            comments,
            true
        );
    }
